...
LORA_MATH_PATH = "/home/haoxuan/Desktop/SpeculativeDecoding/models/qwen3-4b-lora-mixed"


MATH_SYSTEM = "你是一个数学助手。请清晰写出推理与计算步骤,一步一步完成计算推理，最终给出准确答案。"
...
def main() -> None:
  ...
  out_path = output_dir / "qwen3_4b_lora-mixed_answers.txt"
